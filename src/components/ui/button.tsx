/**
 * ปุ่ม — คอมโพเนนต์ shadcn/ui
 * เขียนไว้ในโปรเจกต์เลย (นี่คือวิธีของ shadcn: คัดลอกโค้ดมาเป็นของเรา ไม่ใช่ติดตั้งเป็น library)
 * ขนาดปุ่มตั้งใจให้แตะง่ายบนมือถือ — ความสูงขั้นต่ำ 44px ตามแนวทางของ Apple
 */
