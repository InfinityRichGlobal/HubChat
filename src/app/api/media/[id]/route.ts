 ...
 *
 * 🔴 ทำไมต้องผ่านเส้นนี้ ไม่ให้เบราว์เซอร์ไปโหลดจาก Storage ตรง ๆ :
 ...
 *
 * ⚠️ credential ของ Storage อยู่ฝั่งเซิร์ฟเวอร์เท่านั้น ไม่มีทางหลุดออกไปที่เบราว์เซอร์
 */
  ...
  try {
    ...
    if (asset.status !== 'stored' || !asset.storage_key) {
      ...
      const why =
        ...
        : asset.status === 'skipped' ? 'ข้ามการจัดเก็บตอนที่ไฟล์นี้เข้ามา'
